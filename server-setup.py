...
container = {
    "@context":
    ["http://www.w3.org/ns/anno.jsonld", "http://www.w3c.org/ns/ldp.jsonld"],
    "type": ["BasicContainer", "AnnotationCollection"],
    "label":
    "A Basic Annotation Container",
    "creator": {
...
if '--put' in sys.argv:
    ...
    phdrs = {
        "Prefer":
        'return=representation;include="http://www.w3.org/ns/oa#PreferContainedURIs"'
    }
